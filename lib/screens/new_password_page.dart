...
import 'package:mypolling/screens/confirm_new_password.dart';
...
class _NewPasswordPageState extends State<NewPasswordPage> {
  ...
  Widget _buildForm({required GlobalKey<FormState> key}) {
    return Column(
      ...
      children: [
        _buildGreyText("Nouveau Mot de passe"),
  ...
  Widget _buildLoginButon() {
    return ElevatedButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context)=>ConfirmNewPassword()));
        },
